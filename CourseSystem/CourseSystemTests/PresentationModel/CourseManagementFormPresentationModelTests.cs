...
namespace CourseSystem.Tests
{
    ...
    public class CourseManagementFormPresentationModelTests
    {
        ...
        public void AddIntoNotEnabledCourseListAndCourseTabTest()
        {
            ...
            Assert.AreEqual(Tuple.Create((int)Department.NotEnabledList, (int)Department.ComputerScience3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(0));
        }
        ...
        {
            courseManagementFormPresentationModel.AddIntoCourseList(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.ComputerScience3, (int)Department.ComputerScience3, 0), modifyCourseInfo, windowsProgrammingCourseInfo, (int)Department.ElectronicEngineering3);
            ...
            Assert.AreEqual(Tuple.Create((int)Department.ElectronicEngineering3, (int)Department.ElectronicEngineering3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(0));
        ...
        public void SaveModifyCourseMainForEnabledTwoSuccessTest()
        {
            ...
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.SelectedList, (int)Department.ComputerScience3, 1), modifyCourseInfo, modifyCourseInfo, (int)Department.ComputerScience3);
            ...
            Assert.AreEqual(Tuple.Create((int)Department.SelectedList, (int)Department.ComputerScience3, 1), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(1));
            Assert.AreEqual("編輯成功", message);
        }
        ...
        public void SaveModifyCourseMainForEnabledTwoFailTest()
        {
            ...
            presentationModel.AddIntoSelectedCourseListAndCourseTab(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            presentationModel.AddIntoSelectedCourseListAndCourseTab(modifyCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.SelectedList, (int)Department.ComputerScience3, 1), windowsProgrammingCourseInfo, modifyCourseInfo, (int)Department.ElectronicEngineering3);
            Assert.AreEqual(modifyCourseInfo, presentationModel.GetSelectedCourseList[1]);
            Assert.AreEqual(2, presentationModel.GetSelectedCourseList.Count());
            Assert.AreEqual(Tuple.Create((int)Department.SelectedList, (int)Department.ComputerScience3, 1), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(1));
        ...
        {
            courseManagementFormPresentationModel.AddIntoNotEnabledCourseListAndCourseTab(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.NotEnabledList, (int)Department.ComputerScience3, 0), windowsProgrammingCourseInfo, windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
        ...
        public void SaveModifyCourseMainForEnabledThreeForSelectedSuccessTest()
        {
            ...
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), modifyCourseInfo, modifyCourseInfo, (int)Department.ComputerScience3);
            Assert.AreEqual(0, courseManagementFormPresentationModel.GetNotEnabledCourseList.Count);
        ...
        public void SaveModifyCourseMainForEnabledThreeForSelectedFailTest()
        {
            ...
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForEnabled(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), windowsProgrammingCourseInfo, windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            ...
            Assert.AreEqual(windowsProgrammingCourseInfo, courseManagementFormPresentationModel.GetNotEnabledCourseList[0]);
            Assert.AreEqual(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(1));
            Assert.AreEqual("編輯失敗\n此編輯會導致已選課程發生:\n課號相同:「291710 視窗程式設計」\n課程名稱相同:「291710 視窗程式設計」\n衝堂:「291710 視窗程式設計」", message);
        }
        ...
        {
            courseManagementFormPresentationModel.AddIntoCourseList(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForNotEnabled(Tuple.Create((int)Department.ComputerScience3, (int)Department.ComputerScience3, 0), modifyCourseInfo, (int)Department.ComputerScience3);
            Assert.AreEqual(0, courseManagementFormPresentationModel.GetCourseListCollection[(int)Department.ComputerScience3].Count());
        ...
        {
            presentationModel.AddIntoSelectedCourseListAndCourseTab(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForNotEnabled(Tuple.Create((int)Department.SelectedList, (int)Department.ComputerScience3, 0), modifyCourseInfo, (int)Department.ComputerScience3);
            Assert.AreEqual(0, courseManagementFormPresentationModel.GetSelectedCourseList.Count());
            Assert.AreEqual(modifyCourseInfo, courseManagementFormPresentationModel.GetNotEnabledCourseList[0]);
            Assert.AreEqual(1, courseManagementFormPresentationModel.GetNotEnabledCourseList.Count());
            Assert.AreEqual(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(0));
            Assert.AreEqual("編輯成功", message);
        }
        ...
        {
            courseManagementFormPresentationModel.AddIntoNotEnabledCourseListAndCourseTab(windowsProgrammingCourseInfo, (int)Department.ComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForNotEnabled(Tuple.Create((int)Department.NotEnabledList, (int)Department.ComputerScience3, 0), modifyCourseInfo, (int)Department.ComputerScience3);
            Assert.AreEqual(modifyCourseInfo, courseManagementFormPresentationModel.GetNotEnabledCourseList[0]);
            Assert.AreEqual(1, courseManagementFormPresentationModel.GetNotEnabledCourseList.Count());
            Assert.AreEqual(Tuple.Create((int)Department.NotEnabledList, (int)Department.ComputerScience3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(0));
            Assert.AreEqual("編輯成功", message);
        ...
        {
            courseManagementFormPresentationModel.AddIntoNotEnabledCourseListAndCourseTab(windowsProgrammingCourseInfo, (int)Department.SelectedComputerScience3);
            string message = courseManagementFormPresentationModel.SaveModifyCourseMainForNotEnabled(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), modifyCourseInfo, (int)Department.ComputerScience3);
            Assert.AreEqual(modifyCourseInfo, courseManagementFormPresentationModel.GetNotEnabledCourseList[0]);
            Assert.AreEqual(1, courseManagementFormPresentationModel.GetNotEnabledCourseList.Count());
            Assert.AreEqual(Tuple.Create((int)Department.NotEnabledList, (int)Department.SelectedComputerScience3, 0), courseManagementFormPresentationModel.GetCourseDepartmentBySelectedIndex(0));
            Assert.AreEqual("編輯成功", message);
